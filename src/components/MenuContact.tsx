  ...
  return (
    <div className=''>
      <button
        ...
        type="button"
        className="fixed bottom-8 md:bottom-20 right-2 md:right-14 z-10 inline-flex items-center gap-x-1 font-sans text-sm font-semibold leading-6 text-gray-900"
      >
        <div className="rounded-full bg-yellow-500 p-1.5 font-bold text-white">
          <svg
            width="34"
            height="35"
            viewBox="0 0 34 35"
      ...
      {isMenu.visible && (
        <div className="fixed bottom-14 right-4 md:bottom-24 md:right-14 mt-5 flex px-4">
