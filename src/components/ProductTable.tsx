...
const ProductList: React.FC = () => {
  const products: Product[] = [
    ...
    { id: 10, name: 'Chân đèn', catalogue: '(Có thể gắn bàn hoặc cắm đất đều được)', image: chanden.src, price: 20, quantity: 1 },
    ...
    { id: 17, name: 'Đèn Vintage', catalogue: '(đã kèm pin, thời gian chiếu sáng 8h-10h)', image: dendeban.src, price: 15, quantity: 1 },
    { id: 18, name: 'Đèn led tròn ', catalogue: '(đã kèm pin, thời gian chiếu sáng 8-10h)', image: denled.src, price: 20, quantity: 1 },
    { id: 19, name: 'Đèn led ngôi sao', catalogue: '(đã kèm pin, thời gian chiếu sáng 8-10h)', image: denngoisao.src, price: 30, quantity: 1 },
    { id: 20, name: 'Đèn sinh hoạt', catalogue: '(kèm cặp pin thêm miễn phí, tổng thời gian chiếu sáng 8-12h)', image: densinhhoat.src, price: 30, quantity: 1 },
    ...
    { id: 22, name: 'Loa Tronsmart T7 Mini', catalogue: 'Loa công suất 15W, dùng đến 12h (bật đèn) và 18h (tắt đèn), Chống nước nhẹ, dải tần 20Hz–20kHz.', image: loa.src, price: 50, quantity: 1 },
    { id: 23, name: 'Quạt tích điện', catalogue: '(Pin 20.000maH, thời gian dùng: 70h (mức thấp), 11h (mạnh nhất), 9h (bật tất cả chức năng); đèn dùng ~300h. Tích hợp đèn 3 mức, đßiều khiển từ xa, hẹn giờ, xoay 180°, kiêm sạc dự phòng.)', image: quat.src, price: 60, quantity: 1 }, 
    ...
    { id: 37, name: 'Máy nướng gà tự động', catalogue: '(sử dụng bằng sạc dự phòng - pin 5000maH quay được 10h, kèm quạt mini và 2 trụ chống, không kèm sạc dự phòng)', image: maynuongtudong.src, price: 50, quantity: 1 },
