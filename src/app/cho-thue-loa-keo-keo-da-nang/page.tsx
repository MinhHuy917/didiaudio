...
export default function ChoThueLoaKeoKeoDaNang() {
  return (
    <>
      <Head>
        <title>Cho Thuê Loa Kẹo Kéo Đà Nẵng - Âm Thanh Cực Hay, Giá Rẻ</title>
        <meta
          name="description"
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="relative w-full h-[500px] rounded-lg overflow-hidden shadow-lg mb-12">
          ...
          <div className="absolute bottom-8 left-8 text-white">
            <h1 className="text-4xl font-bold">Cho Thuê Loa Kẹo Kéo Đà Nẵng</h1>
